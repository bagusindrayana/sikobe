...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .btn.red-sunglo:not(.btn-outline) {
                background-color: #2d57df;
                border-color: #2d57df;
            }

            .btn.red-sunglo:hover {
                background-color: #284bbe !important;
                border-color: #1d3a99 !important;
            }
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-sidebar-closed page-md">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> {{ date('Y') }} &copy; SIKOBE by <a href="https://github.com/feelinc/sikobe" class="font-white" target="_blank">RELAWAN TIK</a>.</div>
