...
var baseUrl = window.location.hostname+'/api'
...
export function getPosts(props) {
  return async (dispatch) => {
    const url = baseUrl+ '/command-posts';
...
export function getAreaPhotos(areaId, props) {
  const url = baseUrl+ '/areas/' + areaId + '/photos';
